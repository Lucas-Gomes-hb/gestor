    ...
    <div id="body-section" class="body-section">
        <div id="users" class="users">
            <div id="registerUser" class="relative registerUser">
                <div class="end marginBottom">
                    <svg onclick="openCreationUser('new')" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
            ...
            <div id="newUsers" class="out boxUser relative top newUsers">
                ...
                <input  id="nextStepUser" type="button" value="Próximo Passo" class="btn btn-primary fullSize " onclick="newUser()">

                    <div id="newAddress" class="non">
                        ...
                        <input type="button" value="Criar" class="btn btn-success fullSize" onclick="newAddress()">
                    </div>
            </div>
        ...
        <div id="items"  class="items">
                <div class="btnPanel">
                    <a class="btn btn-primary halfSize leftBtn" id="collapseRegisterItem">Items Registrados</a>
                    <a class="btn btn-primary-op halfSize rightBtn" id="collapseNewItems">Criar novo item</a>
                </div>
